                ...
                >
                  <div>
                    ...
                    <p className="text-gray-300 text-sm leading-relaxed">
                      Published in DravidianLangTech@NAACL 2025, this paper addresses the rising challenge of AI-generated fake reviews in regional languages. Built a multilingual classification framework using mBERT to distinguish synthetic vs human-authored reviews in Tamil and Malayalam. Achieved <span className="font-bold text-green-400">F1-Score of 0.90</span> (10<sup>th</sup>) in Tamil and <span className="font-bold text-green-400">0.68</span> (28<sup>th</sup>) in Malayalam.
                    </p>
                  </div>
                </a>
              </Tilt>
              ...
              <Tilt glareEnable={true} glareMaxOpacity={0.2} scale={1.02} perspective={1000} tiltMaxAngleX={10} tiltMaxAngleY={10}>
                ...
                >
                  <div>
                    ...
                    <p className="text-gray-300 text-sm leading-relaxed">
                      Part of SemEval-2025 Task 11, this paper explores fine-tuned RoBERTa-large models for nuanced emotion detection and regression. Our system ranked <span className="font-bold text-green-400">31<sup>st</sup></span> in Macro F1 (<span className="font-bold text-green-400">0.75</span>) and <span className="font-bold text-green-400">17<sup>th</sup></span> in Pearson (<span className="font-bold text-green-400">0.75</span>).
                    </p>
                  </div>
                </a>
              </Tilt>
